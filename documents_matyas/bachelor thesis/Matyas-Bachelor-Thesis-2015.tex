...
\begin{document}
	...
	\acknowledgements
	\noindent
	Především bych rád poděkoval vedoucímu mé bakalářské práce Ing. Martinu Tomáškovi za jeho čas, zkušenosti a dobré rady, které mi při psaní práce věnoval. Poděkování patří také celé mé rodině za podporu během studia a všem, kteří se podíleli na testování nebo zapůjčili zařízení potřebné pro vývoj.
